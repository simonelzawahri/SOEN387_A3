...
<div class="mainCreateCourse">
    ...
    <form method="post" action="<%= request.getContextPath() %>/CreateCourse" >
        <div>
            ...
            <input type = "number" name = "course_code" id = "Code" />
            <br>
            <br>
            <label for="Title">Course Title:</label>
            <input type = "text" name = "course_title" id = "Title" />
            <br>
            <br>
            <label for="Semester">Semester:</label>
            <select name="course_semester" id="Semester" required>
            ...
            <input type = "text" name = "course_days" id = "Days" />
            <br>
            <br>
            <label for="Time">Time:</label>
            <input type = "text" name = "course_time" id = "Time" />
            <br>
            <br>
            <label for="Instructor">Instructor:</label>
            <input type = "text" name = "course_instructor" id = "Instructor" />
            <br>
            <br>
            <label for="Room">Room:</label>
            <input type = "text" name = "course_room" id = "Room" />
            <br>
            <br>
            <label for="StartDate">Start Date:</label>
            <input type = "date" name = "course_startdate" id = "StartDate" />
            <br>
            <br>
            <label for="EndDate">End Date:</label>
            <input type = "date" name = "course_enddate" id = "EndDate" />
            <br>
            <br>
            <label for="InstructorID">Instructor ID:</label>
            <input type = "number" name = "course_instructorid" id = "InstructorID" />
            <br>
            <br>
